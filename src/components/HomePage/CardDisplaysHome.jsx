            ...
            >
              ...
              >
                <img
                  ...
                  alt="Aimd"
                  style={{
                    height: isSmallLaptop ? "50px" : isTablet ? "50px" : "70px",
                  }}
                />
            ...
            <Link to={"/"} style={{ textDecoration: "none", width: "auto" }}>
              ...
              >
                <img
                  ...
                  alt="Pregrancy"
                  style={{
                    height: isSmallLaptop ? "50px" : isTablet ? "50px" : "65px",
                  }}
                />
          ...
          <Box sx={{ display: "flex", flexDirection: "row", gap: "15px" }}>
            <Button
              sx={{
                ...
                fontWeight: "800",
                color: "black",
                fontSize: isSmallLaptop ? "14px" : isTablet ? "12px" : "16px",
